...
import { Edge, Node, Community } from '../interface';
import { calculateHullPath } from '@/graph-components/common/util-function';
...
export default class ForceLayout extends BaseLayout {
  ...
  tick() {
    ...
    this.graphInstance.container
      .selectAll('g.hullsG path')
      .attr('d', (d: Community) =>
        calculateHullPath(d.Nodes, this.graph.cfg.radius)
      );
