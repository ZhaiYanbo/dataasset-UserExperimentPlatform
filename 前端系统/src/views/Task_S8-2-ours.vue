<template>
  <div class="page-container">
    <div class="interaction-container">
      ...
      >
        <p>
          恭喜您已完成"基于社群的图计算"实验B, {{ secondsToGo }}s
          后将跳转至"基于中心性的图计算"实验A
        </p>
        <template #footer>
...
export default defineComponent({
  ...
  setup() {
    ...
    const reactiveData = reactive({
      // 任务相关
      taskName: '基于社群的图计算B', // 任务标题
      taskInfosPre: '本实验共3个小任务，任务内容为：', // 任务说明前缀文本
      taskInfos:
        '每个小任务将给出一个图谱的全貌，请观察图谱中各部分结构，然后根据指导员的实验引导，通过交互式方式寻找图谱中的社群关系', // 任务说明文字
        taskIntroImgPath: '../static/task-intro-img/Task_S8-2-ours.png', // 任务介绍图片
      ...
      nextUrl: 'task_S8-3-others', // 下一个路由

      // 问卷相关
      questionList: [
        {
          description:
            '请根据指导员的实验引导，通过下方的“社群检测”交互式方式寻找图谱中的社群关系',
          caseName: 'Case 1',
          caseDataset: case1,
        },
        {
    ...
    const submitRate = () => {
      ...
      const ansObj = {}
      const preDesc = 'S8_2_ours_indicator_'
