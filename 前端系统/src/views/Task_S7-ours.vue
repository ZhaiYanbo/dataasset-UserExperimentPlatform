<template>
  <div class="page-container">
    <div class="interaction-container">
      ...
      >
        <p>
          恭喜您已完成"智能化图交互分析导航"实验B, {{ secondsToGo }}s
          后将跳转至"基于关系链路的图计算"实验A
        </p>
        <template #footer>
...
// 导入图对象和数据
import Graph from '@/graph-components/Task_S7/ourGraph'
import {
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const reactiveData = reactive({
      // 任务相关
      taskID: 'task_S7-ours', // 任务ID
      taskName: '智能化图交互分析导航实验B', // 任务标题
      ...
      taskIntroImgPath: '../static/task-intro-img/Task_S7-ours.png', // 任务介绍图片
      ...
      nextUrl: 'task_S8-1-others', // 下一个路由
      ...
      questionList: [
        {
          ...
          caseDataset: {
            ...
            targetNodeGuid: 'fcc98a03-93d9-412a-a8c5-342223c26bf3',
    ...
    const submitRate = () => {
      ...
      const name = sessionStorage.getItem('name')
      const ansObj = {}
      const preDesc = 'S7_ours_indicator_'
