<template>
  <div class="page-container">
    <div class="interaction-container">
      ...
      >
        <p>
          恭喜您已完成"基于中心性的图计算"实验B, {{ secondsToGo }}s
          后将跳转至"原型系统综合对比评价"
        </p>
        <template #footer>
...
// 导入图对象和数据
import Graph from '@/graph-components/Task_S8-3/ourGraph'
...
export default defineComponent({
  ...
  setup() {
    ...
    const reactiveData = reactive({
      // 任务相关
      taskName: '基于中心性的图计算B', // 任务标题
      taskInfosPre: '本实验共3个小任务，任务内容为：', // 任务说明前缀文本
      taskInfos:
        '每个小任务将给出一个图谱的全貌和该图谱中所含有的中心性节点数量，请观察图谱中各部分结构，然后根据指导员的实验引导，通过交互式方式寻找图谱中的中心性节点', // 任务说明文字
      taskIntroImgPath: '../static/task-intro-img/Task_S8-3-ours.png', // 任务介绍图片
      ...
      nextUrl: 'task_S9', // 下一个路由

      // 问卷相关
      questionList: [
        {
          description:
            '请根据指导员的实验引导，通过下方的“中心性节点计算”交互式方式寻找图谱中的中心性节点',
          caseName: 'Case 1',
          caseDataset: case1,
        },
        {
    ...
    const submitRate = () => {
      ...
      const ansObj = {}
      const preDesc = 'S8_3_ours_indicator_'
