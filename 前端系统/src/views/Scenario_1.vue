<template>
  <div class="page-container">
    <div class="interaction-container">
      ...
      >
        <p>
          恭喜您已完成"场景一迁移测试"实验, {{ secondsToGo }}s
          后将跳转至"场景二迁移测试"实验
        </p>
        <template #footer>
...
// 导入图对象和数据
import Graph from '@/graph-components/Scenario_1'
import {
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    const reactiveData = reactive({
      // 任务相关
      taskID: 'Scenario_1', // 任务ID
      taskName: '场景一迁移测试', // 任务标题
      ...
      questionList: [
        {
          ...
          caseDataset: {
            ...
            multiNodeList: [
              {
                guid: 'e7ba7795-1a63-44bb-8798-7d3555565c9c',
                typeName: 'dli.Table',
                relationshipTypeName: 'ALL',
              },
            ],
          },
        },
